...
AGENTE_FERRAMENTAS_MODELO=<Groq model id, default "openai/gpt-oss-20b">
...
IDENTIFICACAO_VISUAL_MODELO_GEMINI=<Gemini vision model ID, default "gemini-3.5-flash-lite">
