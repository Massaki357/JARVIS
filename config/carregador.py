...
#   }
#
# Arquivo mínimo, de propósito único — ver INTEGRATION.md, seção
# "Interrupção de fala (config.json)", pra reaplicar esse conceito em
# outro cliente sem precisar reler esta conversa.
import json
from pathlib import Path

# Raiz do projeto = um nível acima da pasta config/ (onde este
# arquivo mora) — caminho relativo, nunca fixo pra uma máquina
# específica.
_CAMINHO_CONFIG = Path(__file__).resolve().parent.parent / "config.json"
