...
# persistentes do ALFRED no arquivo memoria.json.
import json
...
# PASTA_DADOS/garantir_pasta apontam pra pasta dados/ na raiz
# do projeto, onde memoria.json e os demais dados ficam.
...
# Pasta dados/, na raiz do projeto — o estado gerado pelo app
# fica separado do código (ver jarvis/caminhos.py).
...
def _criar_arquivo_se_necessario():
    ...
    # Verifica se o arquivo memoria.json ainda não existe.
...
# Lê o arquivo memoria.json e valida seu conteúdo.
def _carregar_dados():
...
# Grava os dados no arquivo memoria.json
