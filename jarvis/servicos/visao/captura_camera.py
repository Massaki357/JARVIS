...
# Mesma técnica de jarvis/servicos/visao/captura_tela.py, copiada de forma
...
# (jarvis/ui/janela_camera.py, aberto por voz via jarvis/pacotes/camera_preview/) e por
...
# Chamada só por jarvis/ui/janela_camera.py ao abrir o preview; o dono do
...
# jarvis/ui/janela_camera.py ao fechar o preview (pelo X ou por voz).
...
# lógica de jarvis/servicos/visao/captura_tela.py._obter_pasta_area_trabalho,
...
# lógica de jarvis/servicos/visao/captura_tela.py._caminho_sem_sobrescrever,
