...
# padrão já usado em jarvis/pacotes/discord_jarvis/cliente.py (discord.py) e
# jarvis/pacotes/rede_jarvis/visualizacao_remota.py (loop dedicado +
...
# pé — idempotente. Ao contrário de rede_jarvis e discord_jarvis (que
...
# jarvis/pacotes/discord_jarvis/cliente.py:_rodar_no_loop_do_bot.
...
# Ponto de entrada usado por jarvis/pacotes/navegador_jarvis/acoes.py pra qualquer
...
# jarvis/pacotes/navegador_jarvis/acoes.py:fechar_navegador).
def fechar():
    _rodar(
        _fechar_tudo_async(),
