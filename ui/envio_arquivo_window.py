# Janela de envio de arquivo — fora de qualquer arquivo _basic.
# processar_arquivo_para_sessao() é reaproveitada pelo
# arrastar-e-soltar da janela de chat (ui/chat_window.py), pra não
...
# gemini/live_client_basic.py). Nunca falha silenciosamente — sempre
