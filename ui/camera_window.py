...
# _basic. Diferente de analisar_camera/tirar_foto_camera (um único
# frame), mostra o vídeo continuamente, atualizado por um QTimer.
#
# Usa o handle COMPARTILHADO da câmera (vision/camera_capture.py) em
...
# comentário no topo de vision/camera_capture.py pro porquê disso —
...
class JanelaCamera(QWidget):
    ...
    def __init__(self, ao_fechar=None):
        ...
        # EnvioArquivoWindow, pra quem criou a janela (main_basic.py)
