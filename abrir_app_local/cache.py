...
# memória conversacional do jarvis (memory/memory_manager.py) — este
...
# mesma técnica já validada em memory/memory_manager.py.
import json
import threading
from pathlib import Path

PASTA_PACOTE = Path(__file__).resolve().parent
ARQUIVO_CACHE = PASTA_PACOTE / "apps_conhecidos.json"
...
# sido aberto com sucesso — quem chama (abrir_app_local/__init__.py)
