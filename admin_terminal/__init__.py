...
# padrão de rede_jarvis/casa_inteligente/delegacao_ia (ver
# INTEGRATION.md).
...
# INTEGRATION.md, seção "Wiring extra por pacote".
_callback_falar = None


# Wiring extra deste pacote (além do contrato padrão
# obter_function_declarations()/despachar()) — ver INTEGRATION.md.
