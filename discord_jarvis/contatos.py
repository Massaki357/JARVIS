...
# abrir_app_local/buscador.py (normalização acento/caixa-insensível
# + exato -> parcial -> difflib) — copiada aqui, não importada de
# outro pacote: cada pacote isolado deste projeto mantém sua própria
# cópia dessa lógica de propósito (mesmo padrão de mailer/,
# casa_inteligente/, admin_terminal/, etc. — ver CLAUDE.md, "cada
