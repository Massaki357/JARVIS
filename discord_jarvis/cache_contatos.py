...
# memory/memory_manager.py e reaproveitada em
# abrir_app_local/cache.py (arquivo temporário + replace, lock de
...
ARQUIVO_CACHE = PASTA_PACOTE / "contatos_conhecidos.json"
...
# sido enviada com sucesso — quem chama (discord_jarvis/__init__.py)
